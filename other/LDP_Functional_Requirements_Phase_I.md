...
| # | Description | Status |
|---|---|---|
| RQ045 | The system shall present DTD, for each program, the applicants in that pool with their committee ranking, their ranked program-option preferences, any supervisor recommendations, and their placement status. | Not Started |
...
| RQ105 | The system shall present the application as distinct sections the applicant can navigate freely, in any order. | Not Started |
